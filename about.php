...
<head>
   ...
   <title>Conocenos | Chiltepín Restaurant</title>
...
<body>
   ...
   <div class="heading">
      ...
      <p><a href="index.php">Inicio</a> <span> / Cónocenos</span></p>
   </div>
   ...
   <section class="reviews">
      ...
      <h1 class="title">Comentarios de nuestros clientes</h1>
